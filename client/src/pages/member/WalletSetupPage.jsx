    ...
    <div className="fade-in" style={{ display: 'flex', flexDirection: 'column', gap: 'var(--gap-lg)', maxWidth: 600 }}>
      ...
      {current && !isEditing ? (
        <Panel style={{ background: 'rgba(16,185,129,0.03)', border: '1px solid var(--border-cyan)', textAlign: 'center', padding: '2.5rem 1.5rem' }}>
          ...
          <div style={{ background: 'var(--bg-alt)', padding: '1rem', borderRadius: 'var(--radius-sm)', border: '1px solid var(--border-subtle)', marginBottom: '1.5rem', position: 'relative' }}>
        ...
        <>
          ...
          <Panel>
            <form onSubmit={handleSubmit(onSubmit)} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              ...
              <div style={{ padding: '1rem', background: 'rgba(255,255,255,0.02)', border: '1px solid var(--border-subtle)', borderRadius: 'var(--radius-sm)', display: 'flex', gap: '0.75rem' }}>
